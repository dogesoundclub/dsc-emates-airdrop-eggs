...
contract DSCWelcomeEggs is Ownable, KIP17Full("DSC WELCOME EGGS (FOR OUR NEW FRIENDS)", "DSCEGGS2"), KIP17Mintable, KIP17Pausable {

    event SetBaseURI(string baseURI);

    string public baseURI = "https://api.dogesound.club/welcomeeggs/";
